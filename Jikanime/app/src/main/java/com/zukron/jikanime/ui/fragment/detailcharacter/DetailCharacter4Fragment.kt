...
import com.zukron.jikanime.adapter.pagedlist.MangaographyPagedListAdapter
import com.zukron.jikanime.repository.datasource.MangaographyDataSource
 ...
 */
class DetailCharacter4Fragment : Fragment(), OnSelectedItemListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val pageListConfig = PagedList.Config.Builder()
                ...
                .build()
        val adapter = MangaographyPagedListAdapter()
        adapter.setOnPagedItemListener(this)

        view.detailAnimePaged_tvTitle.text = getString(R.string.mangaography)
        ...
        detailViewModel.detailCharacter.observe(requireActivity()) {
            val mangaographyDataSource = MangaographyDataSource(it.mangaography)
            val builder = PagedList.Builder(mangaographyDataSource, pageListConfig)
